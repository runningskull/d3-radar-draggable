  ...
  draw: function(id, d, options){
    ...
    for(var j=0; j<cfg.levels; j++){
      ...
      g.selectAll(".levels").data(allAxis).enter().append("svg:line")
       ...
       .attr("class", "line").style("stroke", "#d9d9d9").style("stroke-width", "0.5px").attr("transform", "translate(" + (cfg.w/2-levelFactor) + ", " + (cfg.h/2-levelFactor) + ")");
...
},{"./radar-chart":3}],5:[function(require,module,exports){
//     Underscore.js 1.5.2
